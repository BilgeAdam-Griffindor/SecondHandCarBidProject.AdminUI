...
{
    public interface IBaseServicesInterface<T> where T : class
    {
        ...
        public Task<bool> UpdateAsync<T>(T data, string name, string token);
        public Task<bool> RemoveAsync<T>(object id, string route, string token);
