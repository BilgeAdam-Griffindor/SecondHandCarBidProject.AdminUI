    ...
    public class CarBuyController : Controller
    {
        ...
        public async Task<IActionResult> Index(string brandId = "", string modelId = "", string statusId = "", int page = 1, int itemPerPage = 100)
        {
            ...
            try
            {
                ...
                {
                    throw new Exception("Başarısız işlem. CarBuy/Index Kod: ");
                }
        ...
        public async Task<IActionResult> Add()
        {
            ...
            try
            {
                ...
                {
                    throw new Exception("Başarısız işlem. CarBuy/Add [GET] Kod: ");
                }
        ...
        public async Task<IActionResult> Add(CarBuyAddViewModel viewData)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    {
                        throw new Exception("Başarısız işlem. CarBuy/Add [POST] Kod: ");
                    }
        ...
        public async Task<IActionResult> Update(Guid id)
        {
            ...
            try
            {
                ...
                {
                    throw new Exception("Başarısız işlem. CarBuy/Update [GET] Kod: ");
                }
        ...
        public async Task<IActionResult> Update(CarBuyUpdateViewModel viewData)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    {
                        throw new Exception("Başarısız işlem. CarBuy/Update [POST] Kod: ");
                    }
        ...
        {
            string queryString = "carBuyId=" + id + "&modifiedBy=" + HttpContext.Session.GetString("currentUserId");
            ...
            try
            {
                ...
                {
                    throw new Exception("Başarısız işlem. CarBuy/Delete Kod: ");
                }
