    ...
    public class CarBuyStatusHistoryController : Controller
    {
        ...
        public async Task<IActionResult> Index(int page = 1, int itemPerPage = 100)
        {
            ...
            try
            {
                ...
                {
                    throw new Exception("Başarısız işlem. CarBuyStatusHistory/Index Kod: ");
                }
        ...
        public async Task<IActionResult> Add()
        {
            ...
            try
            {
                ...
                {
                    throw new Exception("Başarısız işlem. CarBuyStatusHistory/Add [GET] Kod: ");
                }
        ...
        public async Task<IActionResult> Add(CarBuyStatusHistoryAddViewModel viewData)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    {
                        throw new Exception("Başarısız işlem. CarBuyStatusHistory/Add [POST] Kod: ");
                    }
        ...
        public async Task<IActionResult> Delete(Guid id)
        {
            ...
            try
            {
                ...
                {
                    throw new Exception("Başarısız işlem. CarBuyStatusHistory/Delete Kod: ");
                }
